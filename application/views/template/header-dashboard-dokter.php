...
<body class="bg-white">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-header">
            <div class="user-pic">
                <img src="<?= base_url() . '/assets/img/' . $dataDokter['profile_pict'] ?>">
            </div>
            <div class="user-info">
                <?php if (isset($dataDokter)) { ?>
                    <span class="user-name"><?= $dataDokter['name'] ?></span>
                <?php } ?>
                <?php if (isset($role)) { ?>
        ...
        <a class="<?php if (isset($class_home)) echo $class_home ?>" href="<?= base_url() . 'dokter/index' ?>">
            <div>
                <i class="fa fa-home" style="color: black;"></i>
                <span>Home</span>
            </div>
        </a>
        <a class="<?php if (isset($class_profile)) echo $class_profile ?>" href="<?= base_url() . 'dokter/profileDokter' ?>">
            <div>
                <i class="fa fa-user-circle"></i>
                <span>Profile</span>
            </div>
        </a>
        <a class="<?php if (isset($class_forum)) echo $class_forum ?>" href="<?= base_url() . 'dokter/forum' ?>">
            <div>
                <i class="fa fa-comment-alt"></i>
                <span>Forum</span>
            </div>
        </a>
        <a class="<?php if (isset($class_myforum)) echo $class_myforum ?>" href="<?= base_url() . 'dokter/myforum' ?>">
            <div>
                <i class="far fa-comment-alt"></i>
                <span>Komen Saya</span>
            </div>
        </a>
